...
#region WeatherReportConstructor
        ...
        {
            var generator = new Random((int)(Math.Abs(latitude) + Math.Abs(longitude) + daysInFuture));

            HiTemperature = generator.Next(-50, 50);
            LoTemperature = generator.Next(-50, HiTemperature);
